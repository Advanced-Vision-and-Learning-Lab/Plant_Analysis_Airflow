...
class Plant_Analysis:
    ...
    def __init__(self):
        ...
        self.service_type = 0
        #self.input_folder_path = raw_images_folder
        self.output_folder_path = None
        self.show_raw_images = True
        self.show_color_images = True
        self.plant_paths = {}
        self.plant_stats = {}
        self.interm_result_folder = './Interm_Results'
    ...
    def save_interm_result(self):

        batch = self.batch
        self.pcv_outputs = pcv.outputs.observations
    ...
    def get_ndvi_image_indices(self):
