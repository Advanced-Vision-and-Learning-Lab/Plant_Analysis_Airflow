...
class GUI_Viz():
    ...
    def __init__(self, result_folder):
        ...
        with self.demo:
            ...
            with gr.Column():
                ...
                self.visualize_button = gr.Button(value = 'View Plant Analysis',
                                          visible = True)
            ...
            self.visualize_button.click(self.analyze_results,
                                       inputs = [],
                                       outputs = [self.summary_statistics_tabs[item] for item in self.statistics_items]+[self.summary_plots[item] for item in self.statistics_items]+[self.summary_galleries[item] for item in self.statistics_items]+[self.plant_select_dropdown,])
    ...
    def analyze_results(self):
        ...
        self.result_dir_path = self.data_folder
